...
public class BlogPostServiceImpl implements BlogPostService {
    ...
    public PagedDTO<BlogPostDTO> getBlogPostList(Integer pageNo, Integer pageSize) {
        ...
        try{
            ...
            List<BlogPostDTO> blogPostDTOList = pageBlogPost.getContent().stream()
                    .map(blogPost -> BlogPostDTO.builder()
                    .id(blogPost.getId())
            ...
            PagedDTO<BlogPostDTO> blogPostDTOPagedDTO = PagedDTO.<BlogPostDTO>builder()
